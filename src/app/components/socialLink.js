        ...
        <div className="mx-auto mt-10  max-w-2xl  gap-x-8 gap-y-16 border-t border-gray-200 pt-10  sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <article className="bg-slate-700 p-10 rounded-xl flex flex-col items-start justify-between">
            <div className="grid lg:grid-cols-6 sm:gap-10 md:gap-10 lg:gap-20 gap-10 md:grid-cols-1 lg:max-w-none">
              ...
              <a href="https://www.facebook.com/kailash.sharma.5030?mibextid=LQQJ4d" target="_blank" className="flex space-x-2 items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-7 w-7"
                  fill="currentColor"
              ...
              <a href="https://instagram.com/_kailash_0?utm_source=qr" target="_blank" className="flex space-x-2 items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-7 w-7"
                  fill="currentColor"
              ...
              <a href="https://www.linkedin.com/in/kailash-sharma-8b5151184" target="_blank" className="flex space-x-2 items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-7 w-7"
                  fill="currentColor"
